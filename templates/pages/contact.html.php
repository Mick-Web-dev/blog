<div class="container">
    <div class="form-group align-items-center">
        <form action="index.php?controller=contact&task=insert" method="POST" class="form-control">
            ...
            <input type="text" name="mail" placeholder="Votre mail !" class="form-control">
            <br>
            <textarea name="message" id="" cols="30" rows="3" placeholder="Votre message ..." class="form-control"></textarea><br>
